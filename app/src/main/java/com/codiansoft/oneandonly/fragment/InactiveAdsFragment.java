...
import com.codiansoft.oneandonly.adapter.RVAdapterMyInactiveAds;
...
public class InactiveAdsFragment extends Fragment {
    ...
    private RVAdapterMyInactiveAds mAdapter;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (result.get("status").equals("success")) {
                                ...
                                mAdapter = new RVAdapterMyInactiveAds(getActivity(), dataModels);
                            ...
                            Toast.makeText(getActivity(), "error: " + ee.toString(), Toast.LENGTH_SHORT).show();
                        }
