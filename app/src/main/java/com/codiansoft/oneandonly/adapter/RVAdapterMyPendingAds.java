...
import static com.codiansoft.oneandonly.fragment.PendingAdsFragment.progressBar;

/**
 * Created by Codiansoft on 8/2/2017.
 */

public class RVAdapterMyPendingAds extends RecyclerView.Adapter<RVAdapterMyPendingAds.MyViewHolder> {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.ivOptions:
                    ...
                    popup.getMenuInflater().inflate(R.menu.my_ads_pending_popup_menu, popup.getMenu());
...
//                                    utilities.dialog("Connection Problem", act);
    ...
    public RVAdapterMyPendingAds(Context c, ArrayList<MyAdsModel> dataModels) {
        this.dataModels = dataModels;
        this.c = c;
    }

    @Override
    public RVAdapterMyPendingAds.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rv_my_ad_item, parent, false);

        return new RVAdapterMyPendingAds.MyViewHolder(itemView);
    }
