...
import static com.codiansoft.oneandonly.fragment.ActiveAdsFragment.progressBar;

/**
 * Created by Codiansoft on 8/1/2017.
 */

public class RVAdapterMyActiveAds extends RecyclerView.Adapter<RVAdapterMyActiveAds.MyViewHolder> {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.ivOptions:
                    ...
                    popup.getMenuInflater().inflate(R.menu.my_ads_active_popup_menu, popup.getMenu());
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                ...
                                case R.id.my_ad_inactivate:

                                    new android.support.v7.app.AlertDialog.Builder(c)
                                            .setTitle("Inactivate ad " + dataModels.get(getAdapterPosition()).getName() + "?")
                                            .setCancelable(false)
                                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    updateAdStatus("i", dataModels.get(getAdapterPosition()).getID(), getAdapterPosition());
                                                }
                                            })
...
//                                    utilities.dialog("Connection Problem", act);
    ...
    public RVAdapterMyActiveAds(Context c, ArrayList<MyAdsModel> dataModels) {
        this.dataModels = dataModels;
        this.c = c;
    }

    @Override
    public RVAdapterMyActiveAds.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.rv_my_ad_item, parent, false);

        return new RVAdapterMyActiveAds.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(RVAdapterMyActiveAds.MyViewHolder holder, int position) {
